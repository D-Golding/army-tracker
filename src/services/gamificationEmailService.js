// services/gamificationEmailService.js - Gamification Email Templates & Sending
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <a href="${window.location?.origin || 'https://app.tabletoaptactica.com'}/dashboard/gamification" 
      ...
      <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; text-align: center; margin-top: 30px;">
        <p style="color: #9ca3af; font-size: 12px; margin: 0;">
          Keep painting, keep achieving!<br>
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <a href="${window.location?.origin || 'https://app.tabletoaptactica.com'}/dashboard/projects" 
...
const generateReEngagementHTML = (userName, daysInactive, userData) => {
  ...
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; background: #f9fafb;">
      ...
      <!-- Motivation & Tips -->
      <div style="background: #e0f2fe; border: 2px solid #0284c7; border-radius: 12px; padding: 20px; margin: 20px 0;">
        <h3 style="color: #0369a1; margin: 0 0 15px 0;">💡 Quick Tips to Get Back In</h3>
        <ul style="color: #0284c7; margin: 0; padding-left: 20px; font-size: 14px;">
          <li style="margin-bottom: 8px;">Start with just 15 minutes on any project</li>
          <li style="margin-bottom: 8px;">Take a quick progress photo to document your return</li>
          <li style="margin-bottom: 8px;">Complete one small step to rebuild momentum</li>
          <li>Share your progress with the community for extra motivation</li>
        </ul>
      </div>
      ...
      <div style="text-align: center; margin: 30px 0;">
        ...
        <a href="${window.location?.origin || 'https://app.tabletoaptactica.com'}/dashboard/projects/create" 
           style="background: transparent; color: #3b82f6; border: 2px solid #3b82f6; padding: 10px 22px; text-decoration: none; border-radius: 8px; display: inline-block; font-weight: bold;">
          Start Fresh Project
        </a>
      </div>
      ...
      <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; text-align: center; margin-top: 30px;">
        <p style="color: #9ca3af; font-size: 12px; margin: 0;">
          We're here when you're ready to continue your painting journey!<br>
          The Tabletop Tactica Team
        </p>
        <p style="color: #9ca3af; font-size: 10px; margin: 10px 0 0 0;">
          You received this because you have community features enabled. 
          <a href="${window.location?.origin || 'https://app.tabletoaptactica.com'}/dashboard/privacy" style="color: #6b7280;">Manage email preferences</a>
        </p>
      </div>
    </div>
  `;
