// services/email/core/accountEmails.js - Account-related email functions
import { collection, addDoc } from 'firebase/firestore';
import { db } from '../../../firebase.js';
import { checkAccountEmailPermissions } from './emailPermissions.js';
...
const generateRecoveryConfirmationHTML = (userName) => {
  return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <a href="${window.location?.origin || 'https://app.tabletoaptactica.com'}/auth" style="background: #3b82f6; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block; margin: 10px 0;">
