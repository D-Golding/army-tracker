// services/email/emailQueue.js - Queue management, rate limiting, and batch processing
import { collection, addDoc, doc, getDoc, updateDoc, query, where, getDocs, serverTimestamp, increment } from 'firebase/firestore';
import { db } from '../../firebase.js';
import { checkGamificationEmailPermissions } from './core/emailPermissions.js';
import {
  sendAchievementDigestEmail,
  sendStreakMilestoneEmail,
  sendWeeklyProgressEmail,
  sendReEngagementEmail
} from './core/gamificationEmails.js';
import { EMAIL_TYPES, EMAIL_SCHEDULE } from '../shared/constants.js';

/**
 * Email batch queue management
 */
const RATE_LIMITS = {
  MAX_EMAILS_PER_DAY: EMAIL_SCHEDULE.MAX_EMAILS_PER_DAY || 2,
  MAX_EMAILS_PER_HOUR: EMAIL_SCHEDULE.MAX_EMAILS_PER_HOUR || 1,
  BATCH_TIME: EMAIL_SCHEDULE.DAILY_BATCH_TIME || '20:00',
  WEEKLY_TIME: EMAIL_SCHEDULE.WEEKLY_BATCH_TIME || '10:00'
};
