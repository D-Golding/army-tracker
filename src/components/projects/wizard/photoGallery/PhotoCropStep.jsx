// components/shared/wizard/photoGallery/PhotoCropStep.jsx - Better layout with controls under image
import React, { useState, useEffect, useRef } from 'react';
import { Edit, SkipForward, ArrowLeft, ArrowRight, Check, Plus, Minus, Square, Smartphone, Monitor } from 'lucide-react';
...
const PhotoCropStep = ({
  ...
  useEffect(() => {
    ...
    if (nextUnprocessedIndex !== -1 && nextUnprocessedIndex !== currentPhotoIndex) {
      ...
      setShowCropper(false); // Reset cropper when changing photos
    }
  ...
  useEffect(() => {
    ...
    const img = new Image();
    const url = URL.createObjectURL(currentFile.originalFile);
  ...
  useEffect(() => {
    ...
    const containerWidth = Math.min(imageData.width * 0.7, 300);
        ...
        <div className="space-y-4">
          ...
          {!showCropper ? (
            ...
            <div className="space-y-6">
              ...
              {/* Crop Size Controls - Under the image */}
